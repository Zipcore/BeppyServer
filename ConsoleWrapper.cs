...
namespace BeppyServer
{
    class Console
    {
        ...
        // "Usable" methods
        public static void Log(string message, params string[] args) => Log(LogLevel.Info, message, args);
        public static void Error(string message, params string[] args) => Log(LogLevel.Error, message, args);
        public static void Exception(Exception e) => Log(LogLevel.Error, e.Message);
        public static void Warning(string message, params string[] args) => Log(LogLevel.Warning, message, args);
    }
}
